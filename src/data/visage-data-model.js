            ...
            changes: new SchemaField({
                ...
                effects: new ArrayField(
                    new SchemaField({
                        ...
                        align: new StringField({
                            required: false,
                            initial: "center",
                            choices: ["top-left", "top", "top-right", "left", "center", "right", "bottom-left", "bottom", "bottom-right"],
                            label: "VISAGE.Editor.Effects.Alignment",
                        }),
                        edge: new StringField({
                            required: false,
                            initial: "on",
                            choices: ["inner", "on", "outer"],
                            label: "VISAGE.Editor.Effects.Edge",
                        }),
                        bindRotation: new BooleanField({ initial: true, label: "VISAGE.Editor.Effects.BindRotation" }),
                        offsetX: new NumberField({ initial: 0, nullable: false, label: "VISAGE.Editor.Effects.OffsetX" }),
                        offsetY: new NumberField({ initial: 0, nullable: false, label: "VISAGE.Editor.Effects.OffsetY" }),
