...
export class VisageSamples extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    static PACKS = [
        { id: "lights", label: "VISAGE.Samples.Pack.Lights.Label", filename: "overlays_light_sources.json", desc: "VISAGE.Samples.Pack.Lights.Desc" },
        { id: "sizes", label: "VISAGE.Samples.Pack.Sizes.Label", filename: "overlays_token_size.json", desc: "VISAGE.Samples.Pack.Sizes.Desc" },
        { id: "scale", label: "VISAGE.Samples.Pack.Scale.Label", filename: "overlays_image_scale.json", desc: "VISAGE.Samples.Pack.Scale.Desc" },
        { id: "orientation", label: "VISAGE.Samples.Pack.Orientation.Label", filename: "overlays_image_orientation.json", desc: "VISAGE.Samples.Pack.Orientation.Desc" },
        { id: "dispositions", label: "VISAGE.Samples.Pack.Dispositions.Label", filename: "overlays_dispositions.json", desc: "VISAGE.Samples.Pack.Dispositions.Desc" },
        { id: "rotation", label: "VISAGE.Samples.Pack.Rotation.Label", filename: "overlays_rotation_lock.json", desc: "VISAGE.Samples.Pack.Rotation.Desc" }
    ];
    ...
    async _onSubmit(event, form, formData) {
        ...
        for (const packId of selectedIds) {
            ...
            try {
                ...
                ui.notifications.error(game.i18n.format("VISAGE.Notifications.Samples.Error", { 
                    label: game.i18n.localize(packDef.label) 
                }));
            }
        }

        ui.notifications.info(game.i18n.format("VISAGE.Notifications.Samples.Complete", { 
            added: totalImported, 
