...
| Version | Changes |
| :--- | :--- |
| **Version 1.2.0** | * Internal: Move module to ApplicationV2 in preparation for implementing a global Visage directory.<br>* Internal: Add data normalisation helper.<br>* Feat: Added internationalision.<br>* Fix: Update migration script as it missed unlinked tokens.|
